...
<div class="row">
    <div class="col-lg-10">
        <div class="box">
            <form action="{{ route('biodata.update', $biodata->id_biodata) }}" method="put" class="form-biodata"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="nik" id="nik" class="form-control" value="{{ $biodata->nik }}"
                                autofocus>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="nama_kader" id="nama_kader" class="form-control"
                                value="{{ $biodata->nama_kader }}" autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control"
                                value="{{ $biodata->tempat_lahir }}" autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control"
                                value="{{ $biodata->tgl_lahir }}" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="email" name="email" id="email" class="form-control"
                                value="{{ $biodata->email }}" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="bumber" name="nohp" id="nohp" class="form-control" value="{{ $biodata->nohp }}"
                                autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="id_bank" id="id_bank" class="form-control" required>
                                <option value="{{ $biodata->id_bank }}">{{$biodata->bank->nama_bank}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="alamat" id="alamat" class="form-control"
                                value="{{ $biodata->alamat }}" autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="id_kota" id="id_kota" class="form-control" required>
                                <option value="{{ $biodata->id_kota }}">{{$biodata->kota->nama_kota}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="id_kecamatan" id="id_kecamatan" class="form-control" required>
                                <option value="{{ $biodata->id_kecamatan }}">{{$biodata->kecamatan->nama_kecamatan}}
                                </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="id_desa" id="id_desa" class="form-control" required>
                                <option value="{{ $biodata->id_desa }}">{{$biodata->desa->nama_desa}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <input type="file" name="path_foto" class="form-control" id="path_foto"
                                onchange="preview('.tampil_foto', this.files[{{ $biodata->foto }}])">
                            <span class="help-block with-errors"></span>
                            <br>
